...
public class HelpPilotFragment extends Fragment {
    ...
    public HelpPilotFragment() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {


        View help =inflater.inflate(R.layout.fragment_pilot_help,container,false);
...
//        Showing progress dialog at user registration time.
        ...
        stringRequest = new StringRequest(Request.Method.GET, Apilist.PILOTHELP,
