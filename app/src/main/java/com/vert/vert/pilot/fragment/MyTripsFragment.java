...
import com.vert.vert.pilot.tab.Completed_Pilot_Booking_Fragment;
import com.vert.vert.pilot.tab.Ongoing_Pilot_Bookings_Fragment;
...
public class MyTripsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Utils.setupViewPager(viewPager_BOOKING,
                new Ongoing_Pilot_Bookings_Fragment(), new Completed_Pilot_Booking_Fragment(),
